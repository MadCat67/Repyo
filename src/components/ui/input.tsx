  ...
  return (
    <div className="space-y-1">
      ...
      <select
        ...
        id={selectId}
        className={cn(
          "flex h-10 w-full cursor-pointer rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500",
          className
        )}
        {...props}
      >
